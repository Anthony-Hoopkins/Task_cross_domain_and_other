addEventListener("DOMContentLoaded", function(){
  ...
  // Получить ссылку на div на странице, которая отображает
  // текст сообщения.
  ...
  function receiveMessage(e) {
    ...
    // Проверка домена.
    if (e.origin !== "http://test-test")
      return;  
   
    messageEle.innerHTML = "Полученное сообщение:" + e.data;
  ...
  // Настройка прослушивателя событий, который вызывает метод receiveMessage (), когда окно
  // получает новый MessageEvent.
